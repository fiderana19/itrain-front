  ...
  return (
    <ScrollView style={stylesPerso.container}>
      <View style={page.paddingnormal}>
        <Text style={styles.font}>CREER UN COMPTE</Text>
        <Marginer value={10} />
        <View>
          ...
          />
          {errors.nom && (
            <Text style={styles.errors}>{errors.nom.message}</Text>
          )}
          ...
          />
          {errors.telephone && (
            <Text style={styles.errors}>{errors.telephone.message}</Text>
          )}
          ...
          <Button title="Creer" onPress={submitSignup(handleSignup)} />
        </View>
        <Marginer value={50} />
        <Link href="/connexion" style={styles.link}>
          <Text> Vous avez deja un compte ? Se connecter</Text>
        </Link>
      </View>
      <Marginer value={50} />
    </ScrollView>
